...
def generate_all_screenshots():
    ...
    test_lines = [
        ...
        "[INFO] Generating test class for contract: shouldCreateOrder.groovy",
        "[INFO] Generating test class for contract: shouldUpdateOrder.groovy",
        "[INFO] -------------------------------------------------------",
        "[INFO]  T E S T S",
        "[INFO] -------------------------------------------------------",
    ...
    create_terminal_image("docs/images/test_results_terminal.png", "Terminal - mvn clean test (Testcontainers + Flyway + 21 Tests Passed)", test_lines, width=1150)
